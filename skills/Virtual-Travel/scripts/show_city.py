...
"""
城市景点图片下载 + 展示脚本
用法：python show_city.py --city 上海 --output-dir "c:\\Users\\Terry\\Desktop\\Virtual-Travel-Skills-main"
输出：JSON 格式的景点数据，包含本地图片路径（供 VS Code Chat 以 file:/// 路径渲染图片）
"""
...
ATTRACTION_DATA = {
    ...
    "广州": {
        "广州塔": {
            ...
            "description": "广州塔是广州市的地标性建筑，总高600米（含天线桅杆），是中国第一高塔、世界第四高塔。塔身楼层为454米，外形独特，以两个椭圆形斜交网格结构呈'扭腰'造型，被誉为'小蛮腰'。夜晚灯光秀璀璨夺目，映照珠江，是广州最浪漫的夜景地标。",
